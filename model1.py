...
class Regressor(pl.LightningModule):
    ...
    def __init__(self, input_channels, output_channels):
        ...
        # self.fc1 = nn.Linear(3*8*8*8, 1024) # multiply channels by the output dimensions
        ...
        for n, case_folder in enumerate(test_cases):
            ...
            with torch.no_grad():
                prediction = sliding_window_inference(inputs=torch.tensor(norm_img), 
                                                    ...
                                                    predictor=self,
                                                    overlap=0.5) # Self calls the forward method of the model
            ...
            nifti_img = nib.funcs.as_closest_canonical(nib.load(os.path.join('/home/valeria/Prediction_stroke_lesion/data/Basal_to_FU1/{}.nii.gz'.format(case_num))))
